...
class SmsCommand24 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sms24:users';
     ...
     * @var string
     */
    protected $description = 'Este comando envia mensaje de recordatorio de la reserva mediante mensaje de texto 24 horas antes';
    ...
    public function handle()
    {
        ...
        $hora_cita =  date("H",strtotime($fecha_actual."+24 hours"));
        $citas = Cita::where('estado','Confirmado')
        ->where('fecha',date("Y-m-d",strtotime($fecha_actual."+24 hours")))->get();
        ...
        foreach($citas as $cita){
            ...
            $this->sendsmsnew24($cita, $profesional,$servicio,$numero);
             }
        }  
    }
    private function sendsmsnew24($dato , $profesional ,$servicio, string $recipient){
