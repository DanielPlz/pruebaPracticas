...
class MensajeCommand24 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'mensajes24:users';
     ...
     * @var string
     */
    protected $description = 'Este comando envia mensaje de recordatorio de la reserva mediante whatsapp 24 horas antes';
