...
Route::post('/dashboardServicios', 'ServiceController@crear')->name('notas.crear');
Route::get('servicios/dashboardServicios', 'ServiceController@blog')->name('dashboardServicios');
