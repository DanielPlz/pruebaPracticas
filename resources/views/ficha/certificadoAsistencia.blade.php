	   ...
	   <table class="table table-sm customer-grid  ">
        <thead>
            <tr  style=" text-align: center;">
               <th class= "mt-3" colspan="4" style="text-align: center; border-style: none;"> <u>CERTIFICADO DE ASISTENCIA </u> </th> 
            </tr>
        </thead>
        <tr >
           <td class= "mt-1" colspan="4"  style="text-align: left; border-style: none; " >
            Quien suscribe, certifica a Sr/a {{$paciente->nombre}} {{$paciente->appat}} {{$paciente->apmat}}, edad {{$edad}} años, RUT {{$paciente->rut}}, inicia proceso psicoterapéutico con psicólogo clínico {{$profesional->user->name}}
             {{$profesional->user->apellido}} desde el día {{$fechaModificadaF}} quien asiste a {{$numeroDeSesiones}} sesiones.
           </td>
		</tr>
