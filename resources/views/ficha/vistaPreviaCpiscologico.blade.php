        ...
        <div class="card-body bg-light text-center">
            <div class="mt-1" >
             ...
             <!-- Fecha -->
              ...
              <!-- Certificado -->
              <form action={{route('certificadoDiagnostico', [ 'ids'=> $ids ])}} method="post" >
                @csrf
                <!-- Diagnostico -->
                ...
                @elseif($manuniC !== 1 )
                  <table class="table table-sm customer-grid " style=" text-align: left; page-break-after">
                    <tr >
                        
                       <td colspan="4"  style=" border-style: none; " >
                        <p style=" text-align: center;"><u>{{$manuniC->nombre}}</u></p>
                       ...
                       @endforeach
                        ...
                        <tr>
                            ...
                            <td class="text-center mt-n4 text-secundary " style="border-style: none;">
