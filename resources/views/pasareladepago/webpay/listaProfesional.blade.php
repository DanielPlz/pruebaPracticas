            ...
            <form action="{{route('pasareladepago.webpay.filtrarPaciente')}}" method="GET">
                ...
                <div class="form-inline float-right mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" style="background-color: #3B83AE; color: white">
                            Buscar Por
                        </span>
                    </div>
                    ...
                    <div class=" input-group-append">
                        <input class="btn btn-primary" style="background-color: #3B83AE;" type="submit" value="Filtrar"></input>
                    </div>
                </div>
